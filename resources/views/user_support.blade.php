        ...
        <div class="panel">
    		...
    		<div id="demo-chat-body" class="collapse in">
                        ...
                        @foreach($usersChat as $chatInfo)
                            ...
                            @endif
    								...
    								<div class="speech">
    									...
    									<p>{{ $chatInfo->msgText }}</p>
    									<p class="speech-time">
    										<i class="fa fa-clock-o fa-fw"></i> {{ $chatInfo->created_at }}
    									</p>
    								</div>
    							</div>
    						</li>
    			...
    			<div class="panel-footer">
    				<div class="row">
                        <form method="POST" action="{{ route('userSupportMsgPost', Auth::guard('web')->user()->id) }}">
                            @csrf
                            <div class="col-xs-9">
                                <input type="text" id="msgText" name="msgText" placeholder="Enter your text" class="form-control chat-input">
                            </div>
                            <div class="col-xs-3">
