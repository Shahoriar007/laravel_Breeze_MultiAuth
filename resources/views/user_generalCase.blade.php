                                                    ...
                                                    <div class="myaccount-content">
                                                        <div class="panel">
                                                            ...
                                                            <div class="panel-heading">
                                                                ...
                                                                <h3 class="panel-title">General Case Chat</h3>
                                                            </div>
                                                            ...
                                                            <div id="demo-chat-body" class="in">
                                                                ...
                                                                <div class="panel-footer">
                                                                    <div class="row">
                                                                        <form class="col-lg-12 mb-3" method="POST" action="{{ route('userGeneralCasePost', Auth::guard('web')->user()->id) }}">

                                                                        @csrf
                                                                        
                                                                        <div class="col-lg-12 mb-3">
                                                                        <textarea oninput="auto_grow(this)" name="generalCaseMsgText"
                                                                                id="generalCaseMsgText" rows="1" class="form-control"
