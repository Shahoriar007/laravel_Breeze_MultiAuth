            ...
            <div class="col-sm-9 col-xs-9 sideBar-main">
              <div class="row">
                <div class="col-sm-6 col-xs-6 sideBar-name">
                  <a href="{{ route('adminSupportMsg',  $chatInfoAll->userId) }}"><span class="name-meta">Msg: {{ $chatInfoAll->msgText }}</a></span>
                  <span class="name-meta">UserId: {{ $chatInfoAll->userId }}</span>
                </div>
...
<form method="POST" action="{{ route('adminSupportMsgPost', $chatInfo->userId) }}">
        ...
        <div class="col-sm-9 col-xs-9 reply-main">
          <input class="form-control" type="text" id="msgText" name="msgText">
        </div>
