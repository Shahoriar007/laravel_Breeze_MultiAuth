...
<head>
    ...
    <title>Chat Lobby - Bootdey.com</title>
            ...
            <div class="chat-room">
                ...
                <aside class="tengah-side">
                    <div class="chat-room-head">
                        <h3>General Massage</h3>
    
                    </div>
                    <div class="room-desk">
                        
                    @foreach( $generalMsg as $msg )
                        <div class="room-box">
                            <h5 class="text-primary"></h5>
                            <p>{{ $msg->msgText }}</p>
                            <p>Date: <span class="text-muted">{{ $msg->created_at->format('Y-m-d') }}</span>  
                            Time: <span class="text-muted">{{ $msg->created_at->format('H:i:s') }}</span> </p>
